...
def build_modify_fcl_cmd(context):
    ...
    if context.stage.stage_type == DefaultStageTypes.GEN:
        ...
        fcl_cmd = '\n'.join([
            ...
            f'''echo "physics.producers.cvneva.TFNetHandler.TFBundle: \\"/lus/flare/projects/dune_hpc/sungbino/software/dune_cvn/dune_cvn_hd_1x2x6_nu_2024_tf211_v04_00_00/\\"" >> {fcl_name}''',
        ])
...
class Reco2FromGenExecutor(WorkflowExecutor):
    """Execute a G4 -> Detsim -> Reco1 -> Reco2 workflow from user settings."""
    """At G4 stage, read a correct input Gen file produced by Linyan"""
